...
class NewsApiClient(object):
    ...
    def get_top_headlines(self, q=None, sources=None, language=None, from_param=None, country=None, category=None, page_size=None,
                          page=None):
        """
    ...
    def get_everything(self, q=None, sources=None, domains=None, from_param=None, to=None, country=None, language=None, sort_by=None,
                       page=None, page_size=None, from_parameter='2017-12-01'):
        """
